        ...
        <div>
            <Navbar></Navbar>
                ...
                <div className="flex flex-col sm:flex-row sm:space-x-20 justify-center items-center space-y-8 sm:space-y-0 pb-3">
                    ...
                    <motion.img  whileHover={{ scale: 1.1 }} src="/images/Arcane-studio.png" alt="Project 1" className="w-full h-48 sm:h-48 object-contain mx-auto rounded-lg md:mt-0 mt-10 px-2" initial={{ opacity: 0 }} animate={{ opacity: 1}} transition={{ duration: 0.5 }} />
                    ...
                    <motion.img whileHover={{ scale: 1.1 }} src="/images/Arcane-studio.png" alt="Project 1" className="w-full h-48 sm:h-48 object-contain mx-auto rounded-lg px-2" initial={{ opacity: 0 }} animate={{ opacity: 1}} transition={{ duration: 0.5 }} />
                        <div className="flex items-center justify-between">
                        <motion.p className="font-medium mt-3" initial={{ opacity: 0 }} animate={{ opacity: 1}} transition={{ duration: 0.5 }}>
                        Landing page for Arcane Studio
                        </motion.p>
                            <motion.button className="w-8 h-8 bg-white rounded-full flex items-center justify-center" initial={{ opacity: 0 }} animate={{ opacity: 1}} transition={{ duration: 0.5 }}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="black" className="w-4 h-4">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
